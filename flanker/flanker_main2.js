...
var repo_site = "https://cdn.jsdelivr.net/gh/2603186F/jsPsych-in-Qualtrics/flanker/";
...
//function get_repo_site(repo_site, library_sound.mp3) {
   // return repo_site + "library_sound.mp3"  ;
//}

//audiotest_trial = {
   // type: 'audio-keyboard-with-replay',
    //stimulus: get_repo_site(repo_site, library_sound.mp3)}

//jsPsych.playTimelineNamed('myAudio');
//var myAudio = document.getElementById('library');
//myAudio.play();

function play() {
    var audio = new Audio('https://cdn.jsdelivr.net/gh/2603186F/jsPsych-in-Qualtrics/flanker/library_sound.mp3');
    audio.play();
}
